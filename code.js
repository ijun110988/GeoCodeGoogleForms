function doGet() {
  ...
  respSheet.getRange(numResponses,numColumns-2).setValue(Utilities.formatDate(new Date(), "GMT+8", "MM/dd/yyyy HH:mm:ss"));
  ...
  respSheet.getRange(numResponses,numColumns-2).setValue(Utilities.formatDate(new Date(), "GMT+8", "MM/dd/yyyy HH:mm:ss")).setFontColor("red");
  ...
  respSheet.getRange(numResponses-i,numColumns-2).setValue(Utilities.formatDate(new Date(), "GMT+8", "MM/dd/yyyy HH:mm:ss")).setFontColor("red");
  ...
  respSheet.getRange(1,numColumns+3).setValue("GeoAddress");
      ...
      if (numResponses==2) {
  respSheet.getRange(numResponses,numColumns+1).setValue(Utilities.formatDate(new Date(), "GMT+8", "MM/dd/yyyy HH:mm:ss"));
  ...
  respSheet.getRange(numResponses,numColumns+1).setValue(Utilities.formatDate(new Date(), "GMT+8", "MM/dd/yyyy HH:mm:ss")).setFontColor("red");
